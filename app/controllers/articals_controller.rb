class ArticalsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to articals_path, status: :see_other, notice: "Artical was successfully destroyed." }
  ...
  private
    ...
    def set_artical
      @artical = Artical.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def artical_params
      params.expect(artical: [ :name ])
    end
end
